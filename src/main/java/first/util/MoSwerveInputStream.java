 ...
 * </pre>
 */
public class MoSwerveInputStream implements Supplier<ChassisSpeeds> {
     ...
     */
    private MoSwerveInputStream(SwerveDrive drive, DoubleSupplier x, DoubleSupplier y) {
     ...
     */
    public MoSwerveInputStream(SwerveDrive drive, DoubleSupplier x, DoubleSupplier y, DoubleSupplier rot) {
        this(drive, x, y);
     ...
     */
    public MoSwerveInputStream(
            SwerveDrive drive, DoubleSupplier x, DoubleSupplier y, DoubleSupplier headingX, DoubleSupplier headingY) {
        this(drive, x, y);
     ...
     */
    public static MoSwerveInputStream of(SwerveDrive drive, DoubleSupplier x, DoubleSupplier y) {
        return new MoSwerveInputStream(drive, x, y);
    }

    private MoSwerveInputStream(MoSwerveInputStream s) {
    ...
    /**
     * Copy the {@link MoSwerveInputStream} object.
     *
     * @return Clone of current {@link MoSwerveInputStream}
     */
    public MoSwerveInputStream copy() {
        return new MoSwerveInputStream(this);
    }
     ...
     * @return self
     */
    public MoSwerveInputStream robotRelative(BooleanSupplier enabled) {
     ...
     * @return self
     */
    public MoSwerveInputStream robotRelative(boolean enabled) {
     ...
     * @return self
     */
    public MoSwerveInputStream driveToPose(
            Supplier<Pose2d> pose, ProfiledPIDController xPIDController, ProfiledPIDController omegaPIDController) {
     ...
     * @return self.
     */
    public MoSwerveInputStream driveToPoseEnabled(BooleanSupplier enabled) {
     ...
     * @return self.
     */
    public MoSwerveInputStream driveToPoseEnabled(boolean enabled) {
     ...
     * @return self
     */
    public MoSwerveInputStream translationHeadingOffset(BooleanSupplier enabled) {
     ...
     * @return self
     */
    public MoSwerveInputStream translationHeadingOffset(boolean enabled) {
     ...
     * @return self
     */
    public MoSwerveInputStream translationHeadingOffset(Rotation2d angle) {
     ...
     * @return self
     */
    public MoSwerveInputStream allianceRelativeControl(BooleanSupplier enabled) {
     ...
     * @return self
     */
    public MoSwerveInputStream allianceRelativeControl(boolean enabled) {
     ...
     * @return self.
     */
    public MoSwerveInputStream cubeRotationControllerAxis(BooleanSupplier enabled) {
     ...
     * @return self.
     */
    public MoSwerveInputStream cubeRotationControllerAxis(boolean enabled) {
        omegaCube = Optional.of(() -> enabled);
        return this;
    }
     ...
     * @return self
     */
    public MoSwerveInputStream cubeTranslationControllerAxis(BooleanSupplier enabled) {
     ...
     * @return self
     */
    public MoSwerveInputStream cubeTranslationControllerAxis(boolean enabled) {
     ...
     * @return self
     */
    public MoSwerveInputStream withControllerRotationAxis(DoubleSupplier rot) {
        controllerOmega = Optional.of(rot);
        return this;
    }
     ...
     * @return self
     */
    public MoSwerveInputStream withControllerHeadingAxis(DoubleSupplier headingX, DoubleSupplier headingY) {
        controllerHeadingX = Optional.of(headingX);
        controllerHeadingY = Optional.of(headingY);
        return this;
    }
     ...
     * @return self
     */
    public MoSwerveInputStream deadband(double deadband) {
        axisDeadband = deadband == 0 ? Optional.empty() : Optional.of(deadband);
        return this;
    }

    /**
     * Scale the translation axis for {@link MoSwerveInputStream} by a constant scalar value.
     *
     * @param scaleTranslation Translation axis scalar value. (0, 1]
     * @return this
     */
    public MoSwerveInputStream scaleTranslation(DoubleSupplier scaleTranslation) {
        translationAxisScale = scaleTranslation == null ? Optional.empty() : Optional.of(scaleTranslation);
        return this;
    }

    /**
     * Scale the rotation axis input for {@link MoSwerveInputStream} to reduce the range in which they operate.
     *
     * @param scaleRotation Angular velocity axis scalar value. (0, 1]
     * @return this
     */
    public MoSwerveInputStream scaleRotation(double scaleRotation) {
     ...
     * @return this.
     */
    public MoSwerveInputStream headingWhile(BooleanSupplier trigger) {
     ...
     * @return this
     */
    public MoSwerveInputStream headingWhile(boolean headingState) {
        if (headingState) {
     ...
     * @return this
     */
    public MoSwerveInputStream aim(Pose2d aimTarget) {
        aim(() -> aimTarget);
        return this;
    }
     ...
     * @return this
     */
    public MoSwerveInputStream aim(Supplier<Pose2d> aimTarget) {
     ...
     * @return {@link MoSwerveInputStream} for chaining.
     */
    public MoSwerveInputStream aimLookahead(Time lookaheadTime) {
     ...
     * @return {@link MoSwerveInputStream} for chaining.
     */
    public MoSwerveInputStream aimFeedforward(double kS, double kV, double kA) {
     ...
     * @return this.
     */
    public MoSwerveInputStream aimWhile(BooleanSupplier trigger) {
    ...
    public Trigger aimLock(Angle tolerance) {
        return new Trigger(() -> aimEnabled.isPresent()
                && aimEnabled.get().getAsBoolean()
                && aimGoalAngle.isPresent()
     ...
     * @return this.
     */
    public MoSwerveInputStream aimWhile(boolean trigger) {
        if (trigger) {
     ...
     * @return this.
     */
    public MoSwerveInputStream aimHeadingOffset(BooleanSupplier enabled) {
     ...
     * @return this.
     */
    public MoSwerveInputStream aimHeadingOffset(boolean enabled) {
     ...
     * @return this.
     */
    public MoSwerveInputStream aimHeadingOffset(Rotation2d offset) {
     ...
     * @return this
     */
    public MoSwerveInputStream translationOnlyWhile(BooleanSupplier trigger) {
     ...
     * @return {@link MoSwerveInputStream} for chaining.
     */
    public MoSwerveInputStream translationOnlyHeading(Angle heading) {
     ...
     * @return this
     */
    public MoSwerveInputStream translationOnlyWhile(boolean translationState) {
        if (translationState) {
    ...
    /**
     * Find {@link SwerveInputMode} based off existing parameters of the {@link MoSwerveInputStream}
     *
    ...
    private SwerveInputMode findMode() {
        if (driveToPoseEnabled.isPresent() && driveToPoseEnabled.get().getAsBoolean()) {
        ...
        } else if (translationOnlyEnabled.isPresent()
                && translationOnlyEnabled.get().getAsBoolean()) {
            ...
            if (aimTarget.isPresent()) {
                ...
                DriverStation.reportError(
                        "Attempting to enter AIM mode without target, please use MoSwerveInputStream.aim() to select a target first!",
                        false);
            }
            ...
            if (controllerHeadingX.isPresent() && controllerHeadingY.isPresent()) {
                ...
                DriverStation.reportError(
                        "Attempting to enter HEADING mode without heading axis, please use MoSwerveInputStream.withControllerHeadingAxis to add heading axis!",
                        false);
            }
        } else if (controllerOmega.isEmpty()) {
            DriverStation.reportError(
                    "Attempting to enter ANGULAR_VELOCITY mode without a rotation axis, please use MoSwerveInputStream.withControllerRotationAxis to add angular velocity axis!",
                    false);
            return SwerveInputMode.TRANSLATION_ONLY;
        }
    ...
    /**
     * Scale the translational axis by the {@link MoSwerveInputStream#translationAxisScale} if it exists.
     *
    ...
    private Translation2d applyTranslationScalar(double xAxis, double yAxis) {
        if (translationAxisScale.isPresent()) {
            ...
            return SwerveMath.scaleTranslation(
                    new Translation2d(xAxis, yAxis), translationAxisScale.get().getAsDouble());
        }
     ...
     * @return Cubed {@link Translation2d} if the {@link MoSwerveInputStream#translationCube} is present.
     */
     ...
     * @return Cubed axis value if the {@link MoSwerveInputStream#omegaCube} is present.
     */
    ...
    private ChassisSpeeds applyTranslationHeadingOffset(ChassisSpeeds speeds) {
        if (translationHeadingOffsetEnabled.isPresent()
            ...
            if (translationHeadingOffset.isPresent()) {
                Translation2d speedsTranslation = new Translation2d(speeds.vxMetersPerSecond, speeds.vyMetersPerSecond)
    ...
    public Translation2d getTargetVector(Pose2d target) {
        ...
        if (aimLookaheadTime.isPresent()) {
            ...
            var poseTransform = new Transform2d(
                    Meters.of(currentFieldOrientedSpeeds.vxMetersPerSecond * aimLookAhead),
    ...
    public AngularVelocity calculateAngularVelocity(Angle target) {
        var omegaRadiansPerSecond = swerveController.headingCalculate(
                swerveDrive.getOdometryHeading().getRadians(), target.in(Radians));
        if (azimuthFeedforward.isPresent()) {
            omegaRadiansPerSecond += azimuthFeedforward
                    .get()
                    .calculateWithVelocities(
                            swerveDrive.getFieldVelocity().omegaRadiansPerSecond, omegaRadiansPerSecond);
        }
        ...
        switch (newMode) {
            case TRANSLATION_ONLY -> {
                omegaRadiansPerSecond =
                        calculateAngularVelocity(lockedHeading.get()).in(RadiansPerSecond);
            ...
            case ANGULAR_VELOCITY -> {
                omegaRadiansPerSecond = applyOmegaCube(applyRotationalScalar(
                                applyDeadband(controllerOmega.get().getAsDouble())))
            ...
            case HEADING -> {
                omegaRadiansPerSecond = swerveController.headingCalculate(
                        ...
                        Rotation2d.fromRadians(swerveController.getJoystickAngle(
            ...
            case AIM -> {
                ...
                //  targetVector =
                // targetVector.div(targetDistance).times(sotmDistanceToRPSMap.get(targetDistance)*flyWheelCircumference)
                //  var shotVector = targetVector.minus(new Translation2d(currentSpeeds.vxMetersPerSecond,
                // currentSpeeds.vyMetersPerSecond);
                var shotVector = targetVector;
                Rotation2d target = shotVector.getAngle();
                if (aimHeadingOffsetEnabled.isPresent()
                        && aimHeadingOffsetEnabled.get().getAsBoolean()
                        && aimHeadingOffset.isPresent()) {
                    target = target.plus(aimHeadingOffset.get());
                }

                aimGoalAngle = Optional.of(target.getMeasure());
                omegaRadiansPerSecond =
                        calculateAngularVelocity(target.getMeasure()).in(RadiansPerSecond);
                speeds = new ChassisSpeeds(vxMetersPerSecond, vyMetersPerSecond, omegaRadiansPerSecond);
                break;
            }
            case DRIVE_TO_POSE -> {
                ...
                traversalVector =
                        traversalVector.unit().times(-translationPIDController.calculate(distanceFromTarget, 0));

                Vector<N2> robotForwardVec = robotPose
                        .transformBy(new Transform2d(1, 0, new Rotation2d()))
                        .getTranslation()
                        .toVector()
                        .minus(robotVec);
                Vector<N2> robotLateralVec = robotPose
