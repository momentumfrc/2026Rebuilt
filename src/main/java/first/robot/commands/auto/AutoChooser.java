...
import first.robot.commands.intake.RollerCommands;
import first.robot.commands.intake.WristCommands;
import first.robot.commands.intake.ZeroIntakeWristCommand;
...
public class AutoChooser {
    ...
    public Command getShootThenBackupCommand() {
        ...
        double minX = org.wpilib.math.util.Units.inchesToMeters(36 / 2);
        double maxX = org.wpilib.math.util.Units.inchesToMeters(650.92 - (36 / 2));
