...
public class IndexerSubsystem extends SubsystemBase {
    ...
    public IndexerSubsystem() {
        indexerMotor = new SparkFlex(Constants.DEFAULT_CAN_BUS, Constants.INDEXER_PORT.address(), MotorType.kBrushless);
        centeringMotor =
                new SparkFlex(Constants.DEFAULT_CAN_BUS, Constants.CENTERING_PORT.address(), MotorType.kBrushless);
